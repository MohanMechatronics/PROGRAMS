...
<div align=center> <img src="" id="vdstream"></div>
    ...
    <br/>
    <div align=center> 
    <button class="btn btn2 triangle-left" id="turnleft" ontouchstart="fetch(document.location.origin+'/control?var=car&val=2');" ontouchend="fetch(document.location.origin+'/control?var=car&val=3');"></button>
    <button class="btn btn5 stop" id="stop" onclick="fetch(document.location.origin+'/control?var=car&val=3'  stop);"></button>
    <button class="btn btn1 triangle-right" id="turnright" ontouchstart="fetch(document.location.origin+'/control?var=car&val=4');" ontouchend="fetch(document.location.origin+'/control?var=car&val=3');" ></button>
    </div>
    <br/>
    <div align=center> 
