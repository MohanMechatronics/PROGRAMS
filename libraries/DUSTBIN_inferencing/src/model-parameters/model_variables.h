...
const char* ei_classifier_inferencing_categories[] = { "CAP", "PAPER" };
...
const ei_config_tflite_eon_graph_t ei_config_graph_6 = {
...
const uint8_t ei_output_tensors_indices_6[1] = { 0 };
const uint8_t ei_output_tensors_size_6 = 1;
ei_learning_block_config_tflite_graph_t ei_learning_block_config_6 = {
    .implementation_version = 1,
    .block_id = 6,
    .output_tensors_indices = ei_output_tensors_indices_6,
    .output_tensors_size = ei_output_tensors_size_6,
    .quantized = 1,
    .compiled = 1,
    .graph_config = (void*)&ei_config_graph_6,
    .dequantize_output = 0,
};
...
ei_fill_result_fomo_i8_config_t ei_fill_result_fomo_i8_config_6 = {
    .threshold = 0.5,
    .out_width = 12,
    .out_height = 12,
...
const ei_postprocessing_block_t ei_postprocessing_blocks[ei_postprocessing_blocks_size] = {
    {
        ...
        .display_fn = NULL,
        .config = (void*)&ei_fill_result_fomo_i8_config_6,
        .input_block_id = 6
    },
};

const ei_impulse_t impulse_758425_0 = {
    .project_id = 758425,
...
ei_impulse_handle_t impulse_handle_758425_0 = ei_impulse_handle_t( &impulse_758425_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_758425_0;
