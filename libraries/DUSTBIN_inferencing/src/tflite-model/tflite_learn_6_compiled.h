...
#ifndef tflite_learn_6_GEN_H
#define tflite_learn_6_GEN_H
...
TfLiteStatus tflite_learn_6_reset( void (*free)(void* ptr) );


// Returns the number of input tensors.
inline size_t tflite_learn_6_inputs() {
  return 1;
}
// Returns the number of output tensors.
inline size_t tflite_learn_6_outputs() {
  return 1;
}
